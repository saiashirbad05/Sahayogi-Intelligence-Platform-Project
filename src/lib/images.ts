...
const NGO_FIXED_IMAGES: Record<string, string> = {
  ...
  'ActionAid': '/images/999/IMG-20260424-WA0005.jpg'
};
...
// ── 999 Asset Library ──────────────────────────────────────────
// High-fidelity field assets provided by the user in the 999 folder.
const NGO_GALLERY_FALLBACKS: string[] = [
  '/images/999/IMG-20260424-WA0002.jpg', '/images/999/IMG-20260424-WA0003.jpg',
  '/images/999/IMG-20260424-WA0004.jpg', '/images/999/IMG-20260424-WA0005.jpg',
  '/images/999/IMG-20260424-WA0006.jpg', '/images/999/IMG-20260424-WA0007.jpg',
  '/images/999/IMG-20260424-WA0008.jpg', '/images/999/IMG-20260424-WA0009.jpg',
  '/images/999/IMG-20260424-WA0010.jpg', '/images/999/IMG-20260424-WA0011.jpg',
  '/images/999/IMG-20260424-WA0012.jpg', '/images/999/IMG-20260424-WA0013.jpg',
  '/images/999/IMG-20260424-WA0014.jpg', '/images/999/IMG-20260424-WA0015.jpg',
  '/images/999/IMG-20260424-WA0016.jpg', '/images/999/IMG-20260424-WA0017.jpg',
  '/images/999/IMG-20260424-WA0018.jpg', '/images/999/IMG-20260424-WA0019.jpg',
  '/images/999/IMG-20260424-WA0020.jpg', '/images/999/IMG-20260424-WA0021.jpg',
  '/images/999/IMG-20260424-WA0022.jpg', '/images/999/IMG-20260424-WA0023.jpg',
  '/images/999/IMG-20260424-WA0024.jpg', '/images/999/IMG-20260424-WA0025.jpg',
  '/images/999/IMG-20260424-WA0026.jpg', '/images/999/IMG-20260424-WA0027.jpg',
  '/images/999/IMG-20260424-WA0028.jpg', '/images/999/IMG-20260424-WA0029.jpg',
  '/images/999/IMG-20260424-WA0030.jpg'
];
...
export const resolveEntityLogo = (entity: any): string => {
  ...
  const LOGO_MAP: Record<string, string> = {
    'pehchaan': '/images/789/images%20%285%29.jpg',
    'bhumi': '/images/789/IMG-20260402-WA0001.jpg', 
    'goonj': '/images/789/IMG-20260402-WA0009.jpg',
    ...
    'actionaid': 'https://cdn.worldvectorlogo.com/logos/actionaid.svg'
  };
...
/**
 * Ensures a high-fidelity image gallery of a specific size.
 * Fills empty slots with non-repeating assets from the 999 library.
 */
export const resolveEntityGallery = (entity: any, count: number = 7): string[] => {
  if (!entity) return NGO_GALLERY_FALLBACKS.slice(0, count);

  const { image_gallery, id, name } = entity;
  const gallery: string[] = [];
  
  // 1. Prioritize existing gallery items if they are valid
  if (image_gallery && Array.isArray(image_gallery)) {
  ...
  // 2. Fill empty slots with unique items from 999 library
  if (gallery.length < count) {
    const safeId = (id || name || '0').toString();
    const seed = safeId.split('').reduce((acc: number, char: string) => acc + char.charCodeAt(0), 0);
    
    let fallbackIndex = seed % NGO_GALLERY_FALLBACKS.length;
    while (gallery.length < count) {
      const nextImg = NGO_GALLERY_FALLBACKS[fallbackIndex % NGO_GALLERY_FALLBACKS.length];
      if (!gallery.includes(nextImg)) {
        gallery.push(nextImg);
      }
      fallbackIndex++;
    }
  }
