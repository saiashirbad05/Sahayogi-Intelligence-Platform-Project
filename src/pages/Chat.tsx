        ...
        <div style={{ padding: '32px 24px', flex: 1, overflowY: 'auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div className="card-premium" style={{ padding: '20px', background: 'var(--off-white)', border: 'none' }}>
               ...
               <div style={{ fontSize: '11px', fontWeight: 800, color: 'var(--text-mid)', letterSpacing: '0.5px' }}>REGISTRY RECORDS</div>
            </div>
            ...
            <div className="card-premium" style={{ padding: '20px', background: 'var(--off-white)', border: 'none' }}>
               ...
               <div style={{ fontSize: '11px', fontWeight: 800, color: 'var(--text-mid)', letterSpacing: '0.5px' }}>RISK REPORTS</div>
            </div>
          </div>
