...
import { getUnsplashUrl, resolveEntityImage, resolveEntityLogo, resolveEntityGallery } from '../lib/images';
      ...
      try {
        ...
        if (data) {
          ...
          const normalized = {
            ...
            gallery: resolveEntityGallery(data, 7),
            banner: resolveEntityGallery(data, 1)[0],
        ...
        <>
          ...
          <section style={{ height: '420px', position: 'relative', overflow: 'hidden' }}>
             <div style={{ 
               ...
               background: `linear-gradient(rgba(10,17,40,0.3) 0%, rgba(10,17,40,0.9) 100%), url(${entity.banner})`,
               ...
               <div>
                ...
                <div style={{ 
                  ...
                  gap: '24px' 
                   ...
                   {entity.gallery?.map((img: any, i: number) => {
              ...
              <div className="card" style={{ padding: '40px', border: '1px solid var(--off-white)', position: 'sticky', top: '120px' }}>
                 ...
                 <div style={{ marginTop: '40px', paddingTop: '40px', borderTop: '1px solid var(--off-white)' }}>
                  ...
                  <div style={{ marginTop: '32px', position: 'relative', borderRadius: '24px', overflow: 'hidden', border: '1px solid var(--off-white)', background: 'white', padding: '12px' }}>
                    ...
                    <img 
                      src="/images/999/IMG-20260424-WA0012.jpg" 
